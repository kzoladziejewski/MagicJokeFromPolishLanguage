...
class TestApp(object):
    ...
    def test_compare_string_positive(self,basic_string, cutet_string, mjfpl):
        assert mjfpl.compare_string(basic_string, cutet_string) == True
    ...
    def test_compare_string_negative(self, basic_string, cutet_string, mjfpl):
        assert mjfpl.compare_string(basic_string, cutet_string) == False
    ...
    def test_merge_find_pos(self, lista, mjfpl):
        ...
        assert mjfpl.merge_find(looking = "afa", lista_words = mjfpl.all_words) == True
    ...
    def test_merge_find_lista_words_exactly_in_center(self, mjfpl, lista, look):
        assert mjfpl.merge_find(look, lista_words=lista) == True
    ...
    def test_merge_find_negative(self, lista, mjfpl):
        ...
        assert mjfpl.merge_find(looking = "bbb", lista_words=mjfpl.all_words) == False
